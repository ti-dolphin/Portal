...
class MaterialDetalhe {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "material_detalhe");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "material_detalhe");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "material_detalhe");
        return new Promise(function (resolve, reject) {
...
module.exports = MaterialDetalhe;