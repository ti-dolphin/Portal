...
class CategoriaTemAtributo {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "categoria_tem_atributo");
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "categoria_tem_atributo");
        return new Promise(function (resolve, reject) {
    ...
    static delete(id) {
        const sql = "delete from categoria_tem_atributo where atributo_id = "+id;
        return new Promise(function (resolve, reject) {
            con.query(sql, function (err, rows, fields) {
                if (err) {
                    reject(err);
...
module.exports = CategoriaTemAtributo;