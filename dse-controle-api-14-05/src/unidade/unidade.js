...
class User {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "unidade");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "unidade");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "unidade");
        return new Promise(function (resolve, reject) {
