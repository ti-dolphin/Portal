...
class Programa {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "programa");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "programa");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "programa");
        return new Promise(function (resolve, reject) {
