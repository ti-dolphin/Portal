...
class ProjetoGrupo {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "projeto_grupo");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "projeto_grupo");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "projeto_grupo");
        return new Promise(function (resolve, reject) {
