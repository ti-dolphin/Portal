...
class ProjetoTimeline {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "projeto_timeline");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "projeto_timeline");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "projeto_timeline");
        return new Promise(function (resolve, reject) {
