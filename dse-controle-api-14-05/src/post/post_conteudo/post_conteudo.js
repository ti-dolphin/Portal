...
class PostConteudo {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "post_conteudo");
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "post_conteudo");
        return new Promise(function (resolve, reject) {
