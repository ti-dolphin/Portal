...
class PostComentario {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "post_comentario");
    ...
    static insert(data) {
        ...
        const sql = sqlUtils.generate_insert_query(data, "post_comentario");
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "post_comentario");
        return new Promise(function (resolve, reject) {
