...
class Fornecedor {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "fornecedor");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "fornecedor");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "fornecedor");
        // console.log(sql);
        return new Promise(function (resolve, reject) {
