...
class PastaPermissao {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "pasta_permissao");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "pasta_permissao");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "pasta_permissao");
        return new Promise(function (resolve, reject) {
    ...
    static delete(id) {
        const sql = "delete from pasta_permissao where id = "+id;
        return new Promise(function (resolve, reject) {
            con.query(sql, function (err, rows, fields) {
                if (err) {
                    reject(err);
