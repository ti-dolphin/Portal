...
class PastaDocumentoNomeTipo {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "pasta_documento_nome_tipo");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "pasta_documento_nome_tipo");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "pasta_documento_nome_tipo");
        return new Promise(function (resolve, reject) {
...
module.exports = PastaDocumentoNomeTipo;