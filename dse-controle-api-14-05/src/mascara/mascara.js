...
class Mascara {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "mascara");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "mascara");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "mascara");
        // console.log(sql);
        return new Promise(function (resolve, reject) {
    ...
    static delete(id) {
        const sql = "delete from mascara where id = "+id;
        return new Promise(function (resolve, reject) {
            con.query(sql, function (err, rows, fields) {
                if (err) {
                    reject(err);
