...
class ProcessoCampoArquivo {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "processo_campo_arquivo");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "processo_campo_arquivo");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "processo_campo_arquivo");
        return new Promise(function (resolve, reject) {
    ...
    static delete(id) {
        const sql = "delete from processo_campo_arquivo where processo_id = "+id;
        return new Promise(function (resolve, reject) {
            con.query(sql, function (err, rows, fields) {
                if (err) {
                    reject(err);
...
module.exports = ProcessoCampoArquivo;