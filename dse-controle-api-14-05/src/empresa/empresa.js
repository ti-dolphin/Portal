...
class Empresa {
    ...
    static select(fields = null, targets = null) {
        const sql = sqlUtils.generate_select_query(targets, fields, "empresa");
     ...
     */
    static insert(data) {
        const sql = sqlUtils.generate_insert_query(data, "empresa");
        //console.log("sql gerado:", sql)
    ...
    static update(data) {
        ...
        const sql = sqlUtils.generate_update_query(data, "empresa");
        return new Promise(function (resolve, reject) {
