...
export default function UploadFile({ multiple = false, error, showPreview = false, files, onRemove, onRemoveAll, sx, editImage, ...other }) {
                ...
                <ListItemSecondaryAction>
                  {
                    file?.type?.includes('image') &&
                      <MIconButton edge="end" size="small" onClick={() => editImage(index)}>
                        <Icon icon={cropFill} />
                      </MIconButton>
                  }
